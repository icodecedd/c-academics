 ...
 * This program manages student records, including adding, modifying, deleting, and viewing student information.
 */
...
// Structures for password and student information
struct pass {
    char pass[25];
} pa;
...
int main() {
    int ch, id, k = 0, i;
    char c, pas[50];
    SetConsoleTitle(L"Student Management System | DIU");
    FILE *fp;
    Student s;
    int option;
    char another;
...
// Function to display individual student records
void Indivisual(FILE *fp) {
    title();
