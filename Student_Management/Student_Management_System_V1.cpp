 ...
 * - Searching for student details by roll number or first name.
 * - Finding students enrolled in a specific course.
 * - Displaying the total number of students in the system.
 * - Deleting a student's record by roll number.
 * - Updating a student's details (first name, last name, roll number, CGPA, or courses).
 * 
